...
static void InitColors(void)
{
    ...
    DefineColor("DesertColor_1",.86,.77,.60);
    DefineColor("DesertColor_2",.47,.34,.19);
    DefineColor("ForestColor_1",.87,.78,.62);
    DefineColor("ForestColor_2",.34,.36,.16);
}
...
//void drawBmp(const char* bmp_path, double x, double y, double width, double height) {
//    // 将英寸转换为像素
//    int px = PixelsX(x);
//    int py = PixelsY(y);
